...
import {
  Loader2, MessageCircle, Send, Sparkles, Users, Download, Zap,
...
type Lead = {
  ...
  email: string | null; product_type: string; status: string;
};
...
function CrmWhatsAppPage() {
  ...
  const runBulk = async () => {
    ...
    if (!useTwilio) { toast.error("Switch to Twilio API to send bulk"); return; }
